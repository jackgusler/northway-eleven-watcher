...
1. GET  /api/unit (Bearer JWT) -> list of all units for property 7086
1. Filter for FloorplanName == “B4”
1. Diff against last run:
...
“”“Wrapper that retries up to 3 times on timeout or 5xx.”””
...
return r
log(f”  attempt {attempt}: HTTP {r.status_code}, retrying…”)
...
if last_exc:
raise last_exc
return r  # last attempt’s response even if 5xx
